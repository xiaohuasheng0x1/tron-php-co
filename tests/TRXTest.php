...
/**
 * This file is part of the tron-php-co package
 *
 * @category tron-php-co
 * @package  tron-php-co
 * @author   xiaohuasheng0x1 <8888028@gmail.com>
 * @license  https://github.com/xiaohuasheng0x1/tron-php-co/blob/master/LICENSE MIT
 * @link     https://github.com/xiaohuasheng0x1/tron-php-co
 */
...
class TRXTest extends TestCase
{
    ...
    {
        $api = new Api(new Saber(['base_uri' => self::URI]));
